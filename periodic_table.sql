...
--
-- Name: elements unique_name_new; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements unique_symbol_new; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_symbol_new UNIQUE (symbol);
